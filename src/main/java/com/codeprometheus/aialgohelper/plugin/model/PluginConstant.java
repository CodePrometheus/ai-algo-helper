package com.codeprometheus.aialgohelper.plugin.model;
...
public class PluginConstant {
    public static final String PLUGIN_ID = "com.codeprometheus.aialgohelper";
    public static final String PLUGIN_NAME = "AI Algo Helper";

    /**
     * 通知分组
     */
    public static final String NOTIFICATION_GROUP = "AI Algo Helper";
    public static final String TOOL_WINDOW_ID = "AI Algo Helper";
    public static final String CONSOLE_WINDOW_ID = "AI Algo Helper Console";

    /**
     * 配置id
     */
    public static final String APPLICATION_CONFIGURABLE_ID = "com.codeprometheus.aialgohelper.settings";

    /**
     * 配置名称
     */
    public static final String APPLICATION_CONFIGURABLE_DISPLAY_NAME = "AI Algo Helper";


    public static final String ACTION_PREFIX = "aiAlgoHelper";
