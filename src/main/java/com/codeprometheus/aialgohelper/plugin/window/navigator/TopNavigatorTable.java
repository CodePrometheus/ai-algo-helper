...
import com.codeprometheus.aialgohelper.plugin.listener.JTableKeyAdapter;
import com.codeprometheus.aialgohelper.plugin.listener.TreeMouseListener;
import com.codeprometheus.aialgohelper.plugin.manager.NavigatorAction;
import com.codeprometheus.aialgohelper.plugin.model.CodeTopQuestionView;
import com.codeprometheus.aialgohelper.plugin.model.PageInfo;
...
public class TopNavigatorTable extends NavigatorTableData<CodeTopQuestionView> {
    ...
    protected JTextPane firstToolTip() {
        ...
        icons.add(AIAlgoHelperIcons.SHARE);
