package com.codeprometheus.aialgohelper.plugin.window.navigator;
...
import com.codeprometheus.aialgohelper.plugin.listener.AllQuestionNotifier;
...
import com.codeprometheus.aialgohelper.plugin.listener.QueryKeyListener;
import com.codeprometheus.aialgohelper.plugin.manager.FindManager;
...
import com.codeprometheus.aialgohelper.plugin.model.*;
import com.codeprometheus.aialgohelper.plugin.utils.URLUtils;
import com.codeprometheus.aialgohelper.plugin.window.NavigatorPanelAction;
...
public class AllNavigatorPanel extends SimpleToolWindowPanel implements NavigatorPanelAction, Disposable {
    ...
    private Map<String, Find> findMap = new HashMap<>();
