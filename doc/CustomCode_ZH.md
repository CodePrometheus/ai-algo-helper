...
<p align="center"><img src="https://cdn.jsdelivr.net/gh/shuzijun/leetcode-editor@master/doc/config-3.0.jpg" alt="config" style="width: auto;height: auto;max-width: 90%; max-height: 90%;"></p>
  ...
  - 更多工具参考[VelocityTool.java](https://github.com/CodePrometheus/ai-algo-helper/blob/main/src/main/java/com/codeprometheus/aialgohelper/plugin/utils/VelocityTool.java)
...
## JAVA常用配置  
  ...
  ```java
    ...
    package com.codeprometheus.aialgohelper.editor.en;
